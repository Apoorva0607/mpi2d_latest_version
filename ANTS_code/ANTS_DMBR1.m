...
%%%%% Mask check stage 06/13/17
% figure(1);imagesc(self_gated_imgs(:,:,ref_frame));colormap gray;axis image
% 
%   mask=roipoly;
%   figure(2);imagesc(model_imgs(:,:,ref_frame));colormap gray;axis image
%   mask1=roipoly;
%   for i=1:nof
%   self_gated_imgs(:,:,i)=mask.*self_gated_imgs(:,:,i);
%   model_imgs(:,:,i)=mask1.*model_imgs(:,:,i);
%   end
 %%%%%%%%%%
