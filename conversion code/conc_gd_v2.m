...
% ----------------------------------------------------------------------
function [gdcurves T1]=conc_gd_v2(curves,seriesNum,data_info)
...
% else
%     NumberOfBaselineFrames=14;
% end
NumberOfBaselineFrames=16;  %%%% Hardcoded and is subject to change from dataset to dataset. It needs to be checked from the signal intensity vs time plots of each datastet.
...
%  T1_0=repmat((1200),[1 TotalFrames]);
gdcurves=(1000./T1-1000./T1_0)./r;% T1 is in ms  
% scale=sum(gdcurves(:,3:7),2)./5;
% scale_0=repmat(scale,[1 TotalFrames]);
%  gdcurves=gdcurves-scale_0;