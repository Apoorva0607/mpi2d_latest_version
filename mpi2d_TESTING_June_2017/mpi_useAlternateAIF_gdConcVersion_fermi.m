function gdcurves=mpi_useAlternateAIF_gdConcVersion_fermi(seriesNumAIF, sliceNumAIF, scaleAIF, sliceNum,seriesNum, outpath, numPreContrast_bld, numPreContrast_tiss, numSkip,framesToSelect, ranget, timeStampFile, timeStampFileAIF,fermiFrameTo)
...
% read in alternate AIF 
   ...
   try load(curvefilename);
    ...
    gdcurves=gdcurves(:,1:fermiFrameTo);
   ...
   si_curves = gdcurves(:,1:fermiFrameTo);
...
gdcurves =[ bldcurve(1:nTimes)'; tisscurves; sat_bldcurve'];  % so in same format as curves
