function [Fsum]=sat_func_fit_5param(x,bldcurve, sat_bldcurve, tisscurve,delta_t,nRegs,fixedDelay, fixedVp, estGlobalDelay)
...
for i=1:nRegs
  [est_curves, tmpbldcurve]=mpi_sat_fwdModel_5param(bldcurve, sat_bldcurve, delta_t, kwi(i), kwo(i), t_delay(i), est_fb(i), spillover(i));
