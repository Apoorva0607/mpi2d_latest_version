...
function [fittedcurve, tmpbldcurve]=mpi_sat_fwdModel_5param(bldcurve, sat_bldcurve, delta_t, kwi, kwo, t_delay, est_fb, spillover)  % note all parameters are scalars!!!
