...
% now lexiscan:
templatedirtxt='/Volumes/Seagate931/Data/DICOM_FILES/P070909/CV_Radial7Off_3.9mladenoscan(53)'
seriesnum=10000 + 53
infilename='nufftP070909MID50_slice1_100iter_3coils_F1000_T900_S0'
outputdirtxt=templatedirtxt;
outfilename=infilename;
load(strcat(inpath,'/',infilename) );   % gives imgrr  
indata=imgrr;   clear imgrr;
...
templatedirtxt='/Volumes/Seagate931/Data/DICOM_FILES/P070909/CV_Radial7Off_3.9mladenoscan(55)'
seriesnum=10000 + 55
infilename='nufftP070909MID50_slice3_100iter_3coils_F1000_T900_S0'
outputdirtxt=templatedirtxt;
outfilename=infilename;
load(strcat(inpath,'/',infilename) );   % gives imgrr  
indata=imgrr;   clear imgrr;
